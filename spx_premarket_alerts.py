...
def main():
    timestamp = datetime.datetime.now(pytz.timezone("US/Central")).strftime("%Y-%m-%d %H:%M")
    ...
    print(f"\n📊 Pre-Market Alert for {timestamp}")
    ...
    log_premarket_prediction(timestamp, spx, es, vix, sentiment_score, direction, news)
